...
class Lightning_YOLO(LightningModule):
    
    def __init__(self,num_classes,in_channels=3,learning_rate = 2e-4):
        super().__init__()
        self.num_classes = num_classes
...
if __name__ == "__main__":
    num_classes = 20
    IMAGE_SIZE = 416
    model = Lightning_YOLO(num_classes=num_classes)
